...
<html>
  <head>
    ...
    <meta name="description" content="Jsnikolov.github.io : " />
    <link rel="stylesheet" type="text/css" media="screen" href="stylesheets/stylesheet.css">
    <title><?php echo 'JSNikolov'  ?></title>
  </head>
  <body>
    ...
    <div id="header_wrap" class="outer">
        <header class="inner">
          <a id="forkme_banner" href="My-Folder/index.html" title="Programming">
			View on GitHub
		  </a>
          <h1 id="project_title">JSNikolov</h1>
